...
window.onload = () => {
  ...
  try{
    console.log("This shouldnt be printed "+local_todoDictionary);
  }catch{
    console.log("This be printed as local not accisble" + );
  }

  try{
    console.log("This shouldnt be printed "+iifi_check);
  }catch{
    console.log("This be printed as local not accisble" + );
  }
