...
window.onload = () => {
    var local_todoDictionary = JSON.parse(localStorage.getItem("todoDictionary"));
...
function sideNavButton(content_type){
    console.log("sideNav  CLisck")
    if(content_type === "todo"){
        document.getElementById("todo_content").style.visibility = "visible";
        document.getElementById("account_content").style.visibility = "hidden";
        document.getElementById("login_content").style.visibility = "hidden";
    }
    if(content_type === "account"){
        document.getElementById("todo_content").style.visibility = "hidden";
        document.getElementById("account_content").style.visibility = "visible";
        document.getElementById("login_content").style.visibility = "hidden";
    }
