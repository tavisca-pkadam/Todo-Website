...
function updateTodoList() {
    ...
    for (const key in todoDictionary) {
        if (todoDictionary.hasOwnProperty(key)) {
            ...
            todo_Data += '<div class="todo_item"><div class="todo_detail">' +element + '</div><div class="todo_edit_btn">Edit</div><div class="todo_remove_btn" onclick="removeTask('+key+')">Remove</div> </div>'
        }
    }
