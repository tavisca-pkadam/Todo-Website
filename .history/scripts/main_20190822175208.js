...
function create_todo_item (sequnce_number, check_box_value, title, id) {
  let todo_item = '<div class="todo_grid_set">'+
                    '<div class="grid_todo_sequence_number">'+
                    sequnce_number +
                   '</div>'+
                    '<div class="grid_todo_sequence_checkbox">'+
                        '<input id="todo_checkbox" type="checkbox" value="true">'+
                    '</div>'+
                    ...
                    '<div class="grid_todo_sequence_edit_button">'+
                        '<div class="todo_edit_btn" onclick="">'+
                            'Edit'+
                          '</div>'+
                    '</div>'+
                    '<div class="grid_todo_sequence_remove_button">'+
                        '<div class="todo_remove_btn" >'+
                            'Remove'+
                          '</div>'+
                    '</div>'+
                  '</div>'
